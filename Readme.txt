...
-Candidates are identified as stars if the entry in the GAIA DR2 has either a parallax or a proper-motion measurement and the significance >3 sigma. Futhermore, candidates are rejected if they are too close to a star (to ensure good observability and avoid artefacts). This criterion is almost identical to that in Hjorth et al. (2012).

-Candidates are identified as a quasar if the SDSS sublass includes the keywords "AGN" or "BROADLINE".
